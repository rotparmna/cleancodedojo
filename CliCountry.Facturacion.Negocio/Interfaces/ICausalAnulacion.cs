// --------------------------------
// <copyright file="ICausalAnulacion.cs" company="InterGrupo S.A.">
//     COPYRIGHT(C) 2013, Intergrupo S.A
// </copyright>
// <summary>Interfaz ICausalAnulacion.</summary>
// --------------------------------
namespace CliCountry.Facturacion.Negocio.Interfaces
{
    ...
    /// <summary>
    /// Interfaz ICausalAnulacion.
    /// </summary>
    public interface ICausalAnulacion
    {
